...
/education-hours.html     교육시간 안내 (준비 중 placeholder — 학과교육 시간 기준이 확정되면 실제 내용으로 교체 필요)
...
15. **교육시간 페이지 실제 내용** — `education-hours.html`은 메인 메뉴에 자리만 먼저 만들어둔 준비 중 페이지입니다. 특히 학과교육 시간은 보유 면허·취득 이력에 따라 기준이 세밀하게 달라져서, 정확한 규정을 확인한 뒤 실제 안내 내용으로 채워 넣어야 합니다.
