...
/education-hours.html     교육시간 안내 (학과교육 시간표: 교시 기준표 + 1·2종 보통/대형·특수면허별 요일·교시 안내, 정적 페이지)
...
15. ~~**교육시간 페이지 실제 내용**~~ — `education-hours.html`에 학과교육 시간표(교시 기준표, 1·2종 보통면허·대형·특수면허 요일별 시간표)를 반영 완료. 장내기능 교육시간표(1~12부, 07:30~20:20)는 이번 개편 대상이 아니라 별도이며, 아직 이 페이지에 반영되지 않았습니다 — 필요하면 추가해주세요. `license-guide.html`과 달리 DB 연동이 안 된 정적 페이지라, 시간표가 바뀌면 `education-hours.html`을 직접 수정해야 합니다.
